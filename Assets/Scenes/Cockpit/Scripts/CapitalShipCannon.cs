...
public class CapitalShipCannon : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        manualYawValue = Vector3.RotateTowards(manualYawValue, yawDestWorld, 2f * Mathf.Deg2Rad, Time.deltaTime * 0.1f);
        ...
        pitchSmooth = Mathf.SmoothDamp(pitchSmooth, pitch, ref pitchVel, 0.2f, 30f);

...
{
    const float k_MouseSensitivityMultiplier = 1f;
    ...
    void Update()
    {
        ...
        mouseX *= mouseSensitivity * k_MouseSensitivityMultiplier * Time.deltaTime;
        mouseY *= mouseSensitivity * k_MouseSensitivityMultiplier * Time.deltaTime;
#else

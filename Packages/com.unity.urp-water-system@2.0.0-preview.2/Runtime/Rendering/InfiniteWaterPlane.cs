...
namespace WaterSystem.Rendering
{
    public class InfiniteWaterPlane : ScriptableRenderPass
    {
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            if (!ExecutionCheck(ref _passData, renderingData.cameraData)) return;
        ...
        private bool ExecutionCheck(ref PassData data, CameraData cameraData)
        {
            if(data.InfiniteMaterial == null || data.InfiniteMesh == null) return false;
